...
const KombuchaProfile = ({ singleKombuchaData }) => {
  const {
    brewery_name, //TODO: get brewery info from company field
    kombucha_type,
    name,
    served_in,
    ABV,
            ...
            <Box display="flex">
              <Box display="flex" alignItems="center">
                <Rating
                  ...
                  precision={0.25}
                  value={Boolean(rating_avg) ? rating_avg : 0}
                  readOnly
                  size="small"
                />
                <Typography
                  ...
                  ml={0.5}
                >
                  {Boolean(rating_avg) && `(${rating_avg.toFixed(2)})`}
                </Typography>
              </Box>
